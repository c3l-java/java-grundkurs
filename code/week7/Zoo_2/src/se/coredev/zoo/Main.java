...
public class Main
{
	public static void main(String[] args)
	{
		...
		new Zoo().addZooListener(new ZooKeeper())
				 .addZooListener(new AnimalTrainer())
				 .addAnimal(new Dog("1002"))
